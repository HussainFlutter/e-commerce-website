      ...
      <div className="flex flex-col pl-10">
        ...
        <div className="flex py-5 flex-col gap-3">
          ...
          <button className="flex bg-transparent p-3 rounded-sm w-full border border-gray-300 items-center gap-3 justify-center">
             <Image alt="google" src={"/google.png"} width={20} height={20} ></Image> Sign up with Google
          </button>
        </div>
        <div className='flex gap-2'>
          Already have an account? 
          <button className="text-red-400 underline" onClick={()=>router.replace('/login')} >Log in</button>
        </div>
      </div>
    </div>
  )
